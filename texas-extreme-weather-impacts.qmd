...
nasa_0207 <- st_mosaic(nasa1_0207, nasa2_0207)
nasa_0216 <- st_mosaic(nasa3_0216, nasa4_0216)

```
### Find the change in night lights intensity (presumably) caused by the storm
```{r}
# blackout data 
blackout <- nasa_0207 - nasa_0216 

# difference between the two dates boolean
diff_light <- (nasa_0207 - nasa_0216) > 200
...
```{r}
# WHY CANT I JUST SUBSET LIKE THIS
...
# use st_bbox
crop_bbox <- c(-96.5, 29, -94.5, 30.5)
st_crop()

# then st_intersects() then st_transform
```
